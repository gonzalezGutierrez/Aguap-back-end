...
<body>
    ...
    <div class="container">
        <div class="form-header">
            <h2 class="text-center">Aguap Admin</h2>
        </div>
        <form action="{{asset('register')}}" method="post">
            @csrf
            <h3 class="text-uppercase">Registro de Repartidores</h3>
            <div class="form-group">
                <input class="form-control-lg" type="text" name="name">
                <label for="name">Nombre</label>
                <div class="error">Escriba un nombre valido.</div>
                <span class="bar"></span>
            </div>
            <div class="form-group">
                <input class="form-control-lg" type="text" name="lastName">
                <label for="lastname">Apellidos</label>
                <div class="error">Escriba un apellido valido</div>
                <span class="bar"></span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input class="form-control-lg" type="tel" name="phone">
                <label for="tel">Telefono</label>
                <div class="error">Datos no validos</div>
                <span class="bar"></span>
            </div>
            ...
            <div class="form-submit">
                <button class="mdb-color darken-3" type="submit">Registrar</button>
                <button onclick="cancel()" class="btn btn-danger darken-3" type="button">Cancelar</button>
            </div>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function() {
            var $input = $('input[type="email"],input[type="password"],input[type="text"],input[type="tel"]');
            $input.val('');
        ...
        function cancel() {
            location.replace("http://localhost:8000/administracion/pedidos");
        }
    </script>
</body>
</html>
